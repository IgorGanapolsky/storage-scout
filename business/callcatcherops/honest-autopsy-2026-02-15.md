...
2. Call the non-bounced “contacted” dentists.
   Phone converts better than email for local services. Start with the dentists in `autonomy_live.sqlite3` that are `service='Dentist' AND status='contacted'` (11 as-of 2026-02-15T18:12Z).
